...
const PrivacyPolicy = () => {
    ...
    return (
        ...
        <>
            ...
            <p>
                Your privacy is important to us. It is {siteTitle}&apos;s policy to respect your privacy regarding any
                information we may collect from you across our website,{" "}
                <Link href="/">https://www.siliconvalley-codecamp.com</Link>, and other sites we own and operate.
            </p>
            <p>
